					...
					<!--<div class="col-md-2  col-sm-6">
						<div class="footer-widget">
							...
							<ul class="list-unstyled list-icon arrow border">
								<li class="no-pt"><a href="template-services.html">Web design</a></li>
								<li><a href="template-services-2.html">UX interactions</a></li>
								<li><a href="template-services-3.html">Consulting</a></li>
								<li><a href="template-services-4.html">Integration</a></li>
							</ul>
						</div>
					</div>-->
					...
					<div class="col-md-12">
						<div class="footer-widget">
							...
							<ul class="social-icons main-color circle social-hover">
								<li>
									<a href="https://www.linkedin.com/in/joebern" class="twitter" title="linkedin"><i class="icon-glyph-308"></i></a>
								</li>
								<li>
									<a href="https://twitter.com/joebernux" class="twitter" title="twitter"><i class="icon-glyph-339"></i></a>
								</li>
								<li>
									<a href="mailto:joebernux@gmail.com" class="twitter" title="email"><i class="icon-glyph-334"></i></a>
								</li>
							</ul> 
							...
							<address class="pt">
								<p>
									...
									<a href="mailto:joebernux@gmail.com">joebernux@gmail.com</a>
								</p>
							</address>
